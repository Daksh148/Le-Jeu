    ...
    function spawn3(){
      ...
      function spawn4(){
        ...
        if(World.frameCount%77===0){
          leftObstacle= createSprite(810,random(200,450),10,70);
          ...
          leftObstacle.velocityX=-9
          leftObstacle.lifetime=200;
          console.log(leftObstacle.x);
          if(leftObstacle.x<=0 ){
        ...
        if(World.frameCount%143===0){
          rightObstacle= createSprite(-10,random(200,450),10,70);
          ...
          rightObstacle.velocityX=9
          rightObstacle.lifetime=1000;
          if(rightObstacle.x>=800){
            score=score+1;
          }
